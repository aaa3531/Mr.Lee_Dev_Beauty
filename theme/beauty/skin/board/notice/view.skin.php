...
<article id="bo_v">
    <ul class="notice-header">
        <li>
            <div class="subject"><?php echo $view['wr_subject']; ?></div>
     ...
     <!-- 게시물 상단 버튼 시작 { -->
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
				<li><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fa fa-list" aria-hidden="true"></i>목록보기<span class="sound_only">목록</span></a></li>
